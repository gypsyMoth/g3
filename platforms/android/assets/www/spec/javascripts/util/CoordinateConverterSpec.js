define(["src/util/CoordinateConverter"], function(CoordinateConverter) {
    ...
    describe( "CoordinateConverter Module", function () {
        ...
        describe( "Project WGS84 Lat/Lon to Nad27 UTM", function () {
            ...
            var expectPointsToBeEqual= function(wgs84LatLonPoint, utmPoint) {
                var nad27LatLonPoint = CoordinateConverter.datumShift(wgs84LatLonPoint);
                expect(CoordinateConverter.project(nad27LatLonPoint)).toEqual(utmPoint);
            };
