...
//            expect(typeof (Sites.NearestPoint)).toBe("function");
        ...
        describe ("Uses a test list of sites", function() {
            ...
            it ("Returns the only site if we have a list of 1", function() {
                Sites.List = [
                    {"zone":17,"xth":"536000","yth":"4184000","quad":"TEST","site_id":1,"grid":"8000","trap_type":"Milk Carton","moth_count":0}
                ];
                var pIn = {Easting: 528000, Northing: 4168000, Zone: 17};
                var pOut = Sites.Nearest(pIn);
                expect(pOut).toEqual(Sites.List[0]);
            });

            it ("Returns the nearest site within a single zone", function() {
                Sites.List = [
                    {"zone":17,"xth":"536000","yth":"4184000","quad":"TEST","site_id":1,"grid":"8000","trap_type":"Milk Carton","moth_count":0},
                    {"zone":17,"xth":"528000","yth":"4168000","quad":"TEST","site_id":2,"grid":"8000","trap_type":"Milk Carton","moth_count":0},
                ...
                var pOut = Sites.Nearest(pIn);
                expect(pOut).toEqual(Sites.List[1]);
            });
