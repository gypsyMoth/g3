...
define('src/views/Splash',['underscore', 'backbone', 'src/App'], function(_, Backbone, App) {
...
define('src/views/Home',['underscore', 'backbone', 'src/App'], function(_, Backbone, App) {
...
define ('src/util/DB',['jquery'], function ($) { 'use strict'
    var my = {};
...
define('src/views/Extras',['underscore', 'backbone', 'src/util/DB', 'src/App'], function(_, Backbone, db) {
...
define("src/util/Date", function(){});

define('src/views/Placement',['underscore', 'backbone', 'src/App', 'src/util/Date'], function(_, Backbone, App, Date) {
...
define('src/views/Caution',['underscore', 'backbone', 'src/App'], function(_, Backbone, App) {
...
define('src/views/Confirm',['underscore', 'backbone', 'src/App', 'src/util/DB'], function(_, Backbone, App, db) {
...
define ('src/util/CoordinateConverter',[],function () {
...
define ('src/util/NearestNeighbor',[],function () {
    var my = {};

    my.getNearestSites = function(currentLocation, sites) {
...
define ('src/util/Encoder',[],function () {
    var my = {};
...
define('src/models/CurrentPosition',['underscore', 'backbone', 'src/util/Encoder', 'src/util/Date'], function(_, Backbone, Encoder, Date) {
...
define('src/models/Splash',['underscore', 'backbone'], function(_, Backbone) {
...
define('src/App',['jquery',
    ...
    var app = {
        ...
        onPositionUpdate: function (position) {
            ...
            var nearest = NearestNeighbor.getNearestSites(utm, this.SitesList);
